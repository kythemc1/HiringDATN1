...
import {  CandidateProjectDto,CreateUpdateCandidateProjectDto } from '../../../../../proxy/dtos/models';
...
@Component({
  standalone: false,
  selector: 'app-create-update-candidate-project-modal',
  templateUrl: './create-update-candidate-project-modal.component.html',
  styleUrls: ['./create-update-candidate-project-modal.component.less'],
})
export class CreateUpdateCandidateProjectModalComponent
  ...
  @Input() updateCandidateProjectDto: CandidateProjectDto;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if ('updateCandidateProjectDto' in changes && this.inline) {
      this.buildForm();
    }
  }
  ...
  save(): void {
    ...
    if (formValue.tenCandidateProject) {
      formValue.tenCandidateProject = formValue.tenCandidateProject.trim();
    }
    ...
    const request = this.updateCandidateProjectDto.id
      ? this.CandidateProjectService.update(this.updateCandidateProjectDto.id, formValue)
      : this.CandidateProjectService.create(formValue);
    this.showLoading();
    request
      .pipe(
        takeWhile(() => this.componentActive),
        tap(() => {
          const isEdit = !!this.updateCandidateProjectDto.id;
  ...
  saveAndNew(): void {
    ...
    const isUpdate = !!this.updateCandidateProjectDto.id;
    const request = isUpdate
      ? this.CandidateProjectService.update(this.updateCandidateProjectDto.id, formValue as CreateUpdateCandidateProjectDto)
      : this.CandidateProjectService.create(formValue as CreateUpdateCandidateProjectDto);
    ...
    request
      .pipe(
        ...
        tap(() => {
          ...
          this.updateCandidateProjectDto = {} as CandidateProjectDto;
          this.form.reset();
