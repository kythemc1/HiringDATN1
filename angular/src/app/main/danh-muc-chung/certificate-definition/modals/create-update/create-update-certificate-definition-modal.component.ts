...
@Component({
  standalone: false,
  selector: 'app-create-update-certificate-definition-modal',
  templateUrl: './create-update-certificate-definition-modal.component.html',
  styleUrls: ['./create-update-certificate-definition-modal.component.less'],
})
export class CreateUpdateCertificateDefinitionModalComponent
  ...
  @Input() updateCertificateDefinitionDto: CertificateDefinitionDto;
  ...
  save(): void {
    ...
    request
      .pipe(
        ...
        tap(() => {
          const isEdit = !!this.updateCertificateDefinitionDto.id;
    ...
    request
      .pipe(
        ...
        tap(() => {
          ...
          this.updateCertificateDefinitionDto = {} as CertificateDefinitionDto;
          this.form.reset();
