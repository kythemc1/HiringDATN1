...
@Component({
  standalone: false,
  selector: 'app-create-update-skill-definition-modal',
  templateUrl: './create-update-skill-definition-modal.component.html',
  styleUrls: ['./create-update-skill-definition-modal.component.less'],
})
export class CreateUpdateSkillDefinitionModalComponent
  ...
  @Input() updateSkillDefinitionDto: SkillDefinitionDto;
  ...
  save(): void {
    ...
    request
      .pipe(
        ...
        tap(() => {
          const isEdit = !!this.updateSkillDefinitionDto.id;
  ...
  saveAndNew(): void {
    ...
    const isUpdate = !!this.updateSkillDefinitionDto.id;
    const request = isUpdate
      ? this.SkillDefinitionService.update(this.updateSkillDefinitionDto.id, formValue as CreateUpdateSkillDefinitionDto)
      : this.SkillDefinitionService.create(formValue as CreateUpdateSkillDefinitionDto);
    ...
    request
      .pipe(
        ...
        tap(() => {
          ...
          this.updateSkillDefinitionDto = {} as SkillDefinitionDto;
          this.form.reset();
