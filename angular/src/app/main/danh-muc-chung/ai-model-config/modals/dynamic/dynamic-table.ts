...
// Columns configuration for AIModelConfig dynamic table
export const AIModelConfigColumns: DynamicTableColumn[] = [
...
// Row actions for AIModelConfig dynamic table
export function CreateAIModelConfigActions(): DynamicTableAction[] {
  return [
...
export function createAIModelConfigTableConfig(): DynamicTableConfig {
  return {
    rows: 10,
