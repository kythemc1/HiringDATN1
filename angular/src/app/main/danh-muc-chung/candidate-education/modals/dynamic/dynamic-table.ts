...
// Columns configuration for CandidateEducation dynamic table
export const CandidateEducationColumns: DynamicTableColumn[] = [
...
// Row actions for CandidateEducation dynamic table
export function CreateCandidateEducationActions(): DynamicTableAction[] {
  return [
...
export function createCandidateEducationTableConfig(): DynamicTableConfig {
  return {
    rows: 10,
