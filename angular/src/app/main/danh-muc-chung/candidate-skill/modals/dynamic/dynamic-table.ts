...
// Columns configuration for CandidateSkill dynamic table
export const CandidateSkillColumns: DynamicTableColumn[] = [
...
// Row actions for CandidateSkill dynamic table
export function CreateCandidateSkillActions(): DynamicTableAction[] {
  return [
...
export function createCandidateSkillTableConfig(): DynamicTableConfig {
  return {
    rows: 10,
