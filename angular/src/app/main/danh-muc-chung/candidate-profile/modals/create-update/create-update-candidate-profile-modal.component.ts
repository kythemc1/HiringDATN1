...
import {  CandidateProfileDto,CreateUpdateCandidateProfileDto } from '../../../../../proxy/dtos/models';
...
@Component({
  standalone: false,
  selector: 'app-create-update-candidate-profile-modal',
  templateUrl: './create-update-candidate-profile-modal.component.html',
  styleUrls: ['./create-update-candidate-profile-modal.component.less'],
})
export class CreateUpdateCandidateProfileModalComponent
  ...
  @Input() updateCandidateProfileDto: CandidateProfileDto;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if ('updateCandidateProfileDto' in changes && this.inline) {
      this.buildForm();
    }
  }
  ...
  save(): void {
    ...
    if (formValue.tenCandidateProfile) {
      formValue.tenCandidateProfile = formValue.tenCandidateProfile.trim();
    }
    ...
    const request = this.updateCandidateProfileDto.id
      ? this.CandidateProfileService.update(this.updateCandidateProfileDto.id, formValue)
      : this.CandidateProfileService.create(formValue);
    this.showLoading();
    request
      .pipe(
        takeWhile(() => this.componentActive),
        tap(() => {
          const isEdit = !!this.updateCandidateProfileDto.id;
  ...
  saveAndNew(): void {
    ...
    const isUpdate = !!this.updateCandidateProfileDto.id;
    const request = isUpdate
      ? this.CandidateProfileService.update(this.updateCandidateProfileDto.id, formValue as CreateUpdateCandidateProfileDto)
      : this.CandidateProfileService.create(formValue as CreateUpdateCandidateProfileDto);
    ...
    request
      .pipe(
        ...
        tap(() => {
          ...
          this.updateCandidateProfileDto = {} as CandidateProfileDto;
          this.form.reset();
