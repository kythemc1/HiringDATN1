...
@Component({
  standalone: false,
  selector: 'app-create-update-ai-prompt-template-modal',
  templateUrl: './create-update-ai-prompt-template-modal.component.html',
  styleUrls: ['./create-update-ai-prompt-template-modal.component.less'],
})
export class CreateUpdateAiPromptTemplateModalComponent
  ...
  @Input() updateAiPromptTemplateDto: AiPromptTemplateDto;
  ...
  save(): void {
    ...
    request
      .pipe(
        ...
        tap(() => {
          const isEdit = !!this.updateAiPromptTemplateDto.id;
