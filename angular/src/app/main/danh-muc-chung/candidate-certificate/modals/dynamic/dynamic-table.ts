...
// Columns configuration for CandidateCertificate dynamic table
export const CandidateCertificateColumns: DynamicTableColumn[] = [
...
// Row actions for CandidateCertificate dynamic table
export function CreateCandidateCertificateActions(): DynamicTableAction[] {
  return [
...
export function createCandidateCertificateTableConfig(): DynamicTableConfig {
  return {
    rows: 10,
