...
export interface CreateUpdateCandidateCertificateDto extends AuditedEntityDto<number> {
  profileId: number;
  name?: string;
  issuer?: string;
  issueDate?: string;
...
export interface CreateUpdateCandidateEducationDto extends AuditedEntityDto<number> {
  profileId: number;
  schoolName?: string;
  degree?: string;
  major?: string;
...
export interface CreateUpdateCandidateExperienceDto extends AuditedEntityDto<number> {
  profileId: number;
  companyName?: string;
  position?: string;
  startDate?: string;
...
export interface CreateUpdateCandidateProfileDto extends AuditedEntityDto<number> {
  userId: number;
  fullName?: string;
  jobTitle?: string;
  aboutMe?: string;
...
export interface CreateUpdateCandidateProjectDto extends AuditedEntityDto<number> {
  profileId: number;
  name?: string;
  linkUrl?: string;
  description?: string;
...
export interface CreateUpdateCandidateSkillDto extends AuditedEntityDto<number> {
  profileId: number;
  skillDefinitionId: number;
  level?: SkillLevel;
}
...
export interface CreateUpdateCompanyDto extends AuditedEntityDto<number> {
  name?: string;
  description?: string;
  website?: string;
  logoUrl?: string;
...
export interface CreateUpdateJobApplicationDto extends AuditedEntityDto<number> {
  jobId: number;
