...
public class HiringDATNDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        HiringDATNGlobalFeatureConfigurator.Configure();
        HiringDATNModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<HiringDATNDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<HiringDATNResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/HiringDATN");

            options.DefaultResourceType = typeof(HiringDATNResource);
        ...
        {
            options.MapCodeNamespace("HiringDATN", typeof(HiringDATNResource));
        });
    }
}
