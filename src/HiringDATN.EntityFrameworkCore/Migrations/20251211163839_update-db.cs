        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    ModelConfigId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiPromptTemplates_AiModelConfigs_ModelConfigId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateCertificates_CandidateProfiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateEducations_CandidateProfiles_ProfileId",
                        column: x => x.ProfileId,
                        principalSchema: "public",
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateExperiences_CandidateProfiles_ProfileId",
                        column: x => x.ProfileId,
                        principalSchema: "public",
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateProjects_CandidateProfiles_ProfileId",
                        column: x => x.ProfileId,
                        principalSchema: "public",
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPostings_Companys_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProfileId = table.Column<long>(type: "bigint", nullable: false),
                    SkillDefinitionId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateSkills_SkillDefinitions_SkillDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentThinkingLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentThinkingLogs_ChatMessages_MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFeedbacks_ChatMessages_MessageId",
                        column: x => x.MessageId,
                        principalSchema: "public",
                        principalTable: "ChatMessages",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    AiMatchingScore = table.Column<double>(type: "double precision", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentThinkingLogs_MessageId",
                schema: "public",
                table: "AgentThinkingLogs",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_AiPromptTemplates_ModelConfigId",
                schema: "public",
                table: "AiPromptTemplates",
                column: "ModelConfigId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateCertificates_ProfileId",
                schema: "public",
                table: "CandidateCertificates",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateEducations_ProfileId",
                schema: "public",
                table: "CandidateEducations",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateExperiences_ProfileId",
                schema: "public",
                table: "CandidateExperiences",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateProjects_ProfileId",
                schema: "public",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateSkills_SkillDefinitionId",
                schema: "public",
                table: "CandidateSkills",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFeedbacks_MessageId",
                schema: "public",
                table: "UserFeedbacks",
                column: "MessageId");
        }
